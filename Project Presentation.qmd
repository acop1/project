...
# Trends Over Time
-   Year-wise Win % for each team from 1999–2024
-   Shows improvement (Ireland), volatility (Argentina), decline (Australia)

-   ![](images/clipboard-1139556712.png)
------------------------------------------------------------------------------

# Modeling Approach

-   **Random Forest + Logistic Regression**
    -   Binary classification (winner vs non-winner)
